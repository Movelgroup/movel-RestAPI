...
namespace apiEndpointNameSpace.Services
{
    public class FirebaseAuthService : IFirebaseAuthService
    {
        ...
        public async Task<AuthResponse> AuthenticateUserMailAsync(string email, string password, List<String> chargerIDs)
        {
            try
            {
        ...
        public async Task<AuthResponse> AuthenticateUserTokenAsync(string FBauthToken, List<String> chargerIDs)
        {
            try
            {
                _logger.LogInformation("Starting authentication for signalR client");
